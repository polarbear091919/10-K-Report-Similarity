...
class SEC10KExtractorChunked:
    ...
    def __init__(self, api_key: str, chunk_size: int = 8000, overlap: int = 500):
        """
...
def main():
    ...
    # SEC API 키 설정
    API_KEY = 'MY API(#100개 Section까지 무료 크롤링 가능 그뒤로는 유료 API입니다)'

    # 청크 설정
    CHUNK_SIZE = 8000  # 각 청크의 최대 8,000문자
